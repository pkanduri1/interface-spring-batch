...
@Component
public class P327Reader extends JdbcPagingItemReader<Map<String, Object>> {
    ...
    public P327Reader(
        ...
        Properties props = YamlPropertyLoaderService.loadProperties(jobName, sourceSystem);

        setDataSource(dataSource);
        setPageSize(pageSize != null ? pageSize : 500);
        ...
        queryProvider.setFromClause("(" + baseQuery + ") temp");
        queryProvider.setSortKeys(Map.of("acct_num", ASCENDING));
